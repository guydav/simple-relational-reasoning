...
def run_containment_support_linear_decoding_single_model_multiple_features(
    ...
    patience_epochs: int = DEFAULT_PATIENCE_EPOCHS, random_seed: int = DEFAULT_RANDOM_SEED, ):
    ...
    if by_target_object:
        for target_object in dataset.target_objects:
            ...
            feature_results = containment_support_linear_decoding_single_model_single_feature(model, decoding_datasets, n_epochs, lr, patience_epochs, batch_size)
...
def run_containment_support_linear_decoding_multiple_models(
    ...
    for name, model_kwargs in zip (model_names, model_kwarg_dicts):
        ...
        model_results = run_containment_support_linear_decoding_single_model_multiple_features(
            model, dataset, n_epochs, lr, by_target_object, by_reference_object, batch_size, validation_proportion, patience_epochs, random_seed)
